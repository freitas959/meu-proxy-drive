...
export function erroGemini(status, detalhe = "", modelo = "") {
  ...
  // 503 quase sempre é congestionamento, não queda. A rota já tenta de novo
  // uma vez antes de chegar aqui, então dizer "fora do ar" seria impreciso e
  // ainda faria a pessoa desistir de uma coisa que costuma passar sozinha.
  if (status === 503) {
    return "O Gemini está congestionado agora — já tentei duas vezes. Espere um minuto e gere de novo, ou use a capa em ilustração.";
  }
